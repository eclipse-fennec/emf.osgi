 ...
 * {@code configuratorType = SETTING_DELEGATE_FACTORY} and a {@code configuratorName}
...
public class DefaultSettingDelegateRegistryComponent {
	...
	public void addSettingDelegateFactory(Factory factory, final EMFConfigurator properties) {
	...
	public void removeSettingDelegateFactory(Factory factory, EMFConfigurator properties) {
		registry.remove(properties.configuratorName());
	}

	@Reference(policy = ReferencePolicy.DYNAMIC, cardinality = ReferenceCardinality.MULTIPLE, target = TARGET)
	public void addSettingDelegateDescriptor(Descriptor descriptor, final EMFConfigurator properties) {
	...
	public void removeSettingDelegateDescriptor(Descriptor descriptor, EMFConfigurator properties) {
		registry.remove(properties.configuratorName());
	}
}
