...
public class PackageClass
{
  ...
  protected final String TEXT_27 = ", genModel = \"";
  protected final String TEXT_28 = "\"";
  protected final String TEXT_29 = ", genModelSourceLocations = {";
  protected final String TEXT_30 = "}";
  protected final String TEXT_31 = ", ecore = \"";
  protected final String TEXT_32 = ", ecoreSourceLocations = \"";
  ...
  protected final String TEXT_81 = "#eNS_URI" + NL + "\t * @see #init()" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_82 = "public";
  protected final String TEXT_83 = "private";
  protected final String TEXT_84 = "()" + NL + "\t{" + NL + "\t\tsuper(eNS_URI, ";
  protected final String TEXT_85 = ");" + NL + "\t}";
  protected final String TEXT_86 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate static boolean isInited = false;" + NL;
  protected final String TEXT_87 = NL + "\t/**" + NL + "\t * Creates, registers, and initializes the <b>Package</b> for this model, and for any others upon which it depends." + NL + "\t *" + NL + "\t * <p>This method is used to initialize {@link ";
  protected final String TEXT_88 = "#eINSTANCE} when that field is accessed." + NL + "\t * Clients should not invoke it directly. Instead, they should simply access that field to obtain the package." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @see #eNS_URI";
  ...
  protected final String TEXT_91 = " init()" + NL + "\t{";
  protected final String TEXT_92 = NL + "\t\t// Initialize the family head to initialize the entire family" + NL + "\t\t";
  protected final String TEXT_93 = ".eINSTANCE.eClass();" + NL + "\t\treturn (";
  protected final String TEXT_94 = ")";
  protected final String TEXT_95 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_96 = ".eNS_URI);";
  protected final String TEXT_97 = NL + "\t\tif (isInited) return (";
  protected final String TEXT_98 = ".eNS_URI);" + NL;
  protected final String TEXT_99 = NL + "\t\tinitializeRegistryHelpers();" + NL;
  protected final String TEXT_100 = NL + "\t\t// Obtain or create and register package" + NL + "\t\tObject registered";
  protected final String TEXT_101 = ".Registry.INSTANCE.get(eNS_URI);" + NL + "\t\t";
  protected final String TEXT_102 = " the";
  protected final String TEXT_103 = " = registered";
  protected final String TEXT_104 = " instanceof ";
  protected final String TEXT_105 = " ? (";
  protected final String TEXT_106 = ")registered";
  ...
  protected final String TEXT_112 = NL + "\t\t// Obtain or create and register interdependencies";
  protected final String TEXT_113 = "Object ";
  protected final String TEXT_114 = "registeredPackage = ";
  protected final String TEXT_115 = ".Registry.INSTANCE.";
  protected final String TEXT_116 = "get";
  protected final String TEXT_117 = "getEPackage";
  protected final String TEXT_118 = "(";
  protected final String TEXT_119 = ".eNS_URI);" + NL + "\t\t";
  protected final String TEXT_120 = " = (";
  protected final String TEXT_121 = ")(registeredPackage instanceof ";
  protected final String TEXT_122 = " ? registeredPackage : ";
  ...
  protected final String TEXT_129 = NL + "\t\t// Create package meta-data objects";
  protected final String TEXT_130 = ".createPackageContents();";
  protected final String TEXT_131 = NL + NL + "\t\t// Initialize created meta-data";
  ...
  protected final String TEXT_138 = ".Descriptor()" + NL + "\t\t\t {";
  protected final String TEXT_139 = NL + "\t\t\t\t @Override";
  protected final String TEXT_140 = NL + "\t\t\t\t public ";
  protected final String TEXT_141 = " getEValidator()" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return ";
  protected final String TEXT_142 = ".INSTANCE;" + NL + "\t\t\t\t }" + NL + "\t\t\t });" + NL;
  protected final String TEXT_143 = NL + "\t\t// Freeze and register the family tree packages.";
  protected final String TEXT_144 = ".freeze();" + NL + "\t\t";
  protected final String TEXT_145 = ".Registry.INSTANCE.put(";
  protected final String TEXT_146 = ".eNS_URI, ";
  ...
  protected final String TEXT_149 = NL + "\t\t// Update the registry and return the package" + NL + "\t\t";
  protected final String TEXT_150 = ".eNS_URI, the";
  protected final String TEXT_151 = ");" + NL + "\t\treturn the";
  protected final String TEXT_152 = NL + "\t}";
  protected final String TEXT_153 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static void initializeRegistryHelpers()" + NL + "\t{";
  protected final String TEXT_154 = ".register" + NL + "\t\t\t(";
  protected final String TEXT_155 = ".class," + NL + "\t\t\t new ";
  protected final String TEXT_156 = ".Helper()" + NL + "\t\t\t {" + NL + "\t\t\t\t public boolean isInstance(Object instance)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return instance instanceof ";
  protected final String TEXT_157 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {" + NL + "\t\t\t\t\t return new ";
  protected final String TEXT_158 = "[size];" + NL + "\t\t\t\t }" + NL + "\t\t\t });";
  protected final String TEXT_159 = ";" + NL + "\t\t\t\t }" + NL + "" + NL + "\t\t\t\t public Object newArrayInstance(int size)" + NL + "\t\t\t\t {";
  ...
  protected final String TEXT_164 = NL + "\t}" + NL + "" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic static class WhiteList implements ";
  protected final String TEXT_165 = ", EBasicWhiteList" + NL + "\t{";
  protected final String TEXT_166 = NL + "\t\t/**" + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\tprotected ";
  protected final String TEXT_167 = NL + "\t * Returns the meta object for class '{@link ";
  ...
  protected final String TEXT_174 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for enum '<em>";
  protected final String TEXT_175 = NL + "\t * Returns the meta object for data type '<em>";
  protected final String TEXT_176 = "</em>'.";
  protected final String TEXT_177 = NL + "\t * Returns the meta object for data type '{@link ";
  protected final String TEXT_178 = "</em>}'.";
  protected final String TEXT_179 = NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->";
  protected final String TEXT_180 = NL + "     * <!-- begin-model-doc -->" + NL + "     * ";
  protected final String TEXT_181 = NL + "     * <!-- end-model-doc -->";
  protected final String TEXT_182 = NL + "\t * @return the meta object for data type '<em>";
  ...
  protected final String TEXT_189 = ".eNS_URI).getEClassifiers().get(";
  ...
  protected final String TEXT_206 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_207 = ") <em>";
  protected final String TEXT_208 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_209 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_210 = ".getEOperations().get(";
  protected final String TEXT_211 = NL + "        return get";
  protected final String TEXT_212 = "().getEOperations().get(";
  protected final String TEXT_213 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_216 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_217 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_218 = NL + "\t@SuppressWarnings(\"deprecation\")";
  protected final String TEXT_219 = NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  ...
  protected final String TEXT_224 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_225 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_226 = " = createEEnum(";
  protected final String TEXT_227 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_228 = " = createEDataType(";
  protected final String TEXT_229 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_230 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_231 = NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_232 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_233 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_234 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_235 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_236 = "_";
  protected final String TEXT_237 = " = addETypeParameter(";
  protected final String TEXT_238 = ", \"";
  protected final String TEXT_239 = "\");";
  protected final String TEXT_240 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_241 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_242 = "g";
  protected final String TEXT_243 = " = createEGenericType(";
  protected final String TEXT_244 = NL + "\t\tg";
  protected final String TEXT_245 = ".";
  protected final String TEXT_246 = "(g";
  protected final String TEXT_247 = ".getEBounds().add(g1);";
  protected final String TEXT_248 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_249 = ".getESuperTypes().add(";
  protected final String TEXT_250 = ".get";
  protected final String TEXT_251 = "());";
  protected final String TEXT_252 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_253 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_254 = ", features, and operations; add parameters";
  protected final String TEXT_255 = " and features; add operations and parameters";
  protected final String TEXT_256 = NL + "\t\tinitEClass(";
  protected final String TEXT_257 = "null";
  protected final String TEXT_258 = ".class";
  protected final String TEXT_259 = "\", ";
  protected final String TEXT_260 = NL + "\t\tinitEReference(get";
  protected final String TEXT_261 = "(), ";
  protected final String TEXT_262 = "g1";
  protected final String TEXT_263 = NL + "\t\tget";
  protected final String TEXT_264 = "().getEKeys().add(";
  protected final String TEXT_265 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_266 = "initEOperation(get";
  protected final String TEXT_267 = "addEOperation(";
  protected final String TEXT_268 = "(), \"";
  protected final String TEXT_269 = ", null, \"";
  protected final String TEXT_270 = "addETypeParameter(op, \"";
  protected final String TEXT_271 = NL + "\t\tt";
  protected final String TEXT_272 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_273 = NL + "\t\taddEException(op, g";
  protected final String TEXT_274 = NL + "\t\taddEException(op, ";
  protected final String TEXT_275 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_276 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_277 = NL + "\t\tinitEEnum(";
  protected final String TEXT_278 = ".class, \"";
  protected final String TEXT_279 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_280 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_281 = NL + "\t\tinitEDataType(";
  protected final String TEXT_282 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_283 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_284 = NL + "\t\t// ";
  protected final String TEXT_285 = "Annotations();";
  protected final String TEXT_286 = NL + "\t}" + NL;
  protected final String TEXT_287 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_288 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_289 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_290 = "null;";
  protected final String TEXT_291 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_292 = "," + NL + "\t\t   source," + NL + "\t\t   new String[]" + NL + "\t\t   {";
  ...
  protected final String TEXT_299 = ".createURI(";
  protected final String TEXT_300 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_301 = "\")";
  protected final String TEXT_302 = NL + "\t\t   });";
  protected final String TEXT_303 = "," + NL + "\t\t   ";
  protected final String TEXT_304 = "new boolean[] { ";
  protected final String TEXT_305 = " }";
  protected final String TEXT_306 = "null,";
  protected final String TEXT_307 = "\",";
  protected final String TEXT_308 = NL + "\t\t   new String[]" + NL + "\t\t   {";
  protected final String TEXT_309 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_310 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_311 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_312 = " uri = ";
  protected final String TEXT_313 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_314 = " resource = new ";
  protected final String TEXT_315 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_316 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_317 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_318 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_319 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_320 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_321 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_322 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_323 = ".\" + eClassifier.getName());";
  protected final String TEXT_324 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_325 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_326 = NL + "\t\t\t\tcase ";
  protected final String TEXT_327 = ":";
  protected final String TEXT_328 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_329 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_330 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_331 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_332 = " addEOperation(";
  protected final String TEXT_333 = " owner, ";
  protected final String TEXT_334 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_335 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL;
  protected final String TEXT_336 = " addEParameter(";
  protected final String TEXT_337 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL;
  protected final String TEXT_338 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_339 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_340 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_341 = "public ";
  protected final String TEXT_342 = "interface Literals" + NL + "\t{";
  protected final String TEXT_343 = NL + "\t\t/**";
  protected final String TEXT_344 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_345 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_346 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_347 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_348 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_349 = NL + "\t\t * @see ";
  protected final String TEXT_350 = NL + "\t\t * ";
  protected final String TEXT_351 = NL + "\t\t * @generated" + NL + "\t\t */";
  protected final String TEXT_352 = NL + "\t\t@Deprecated";
  protected final String TEXT_353 = " = eINSTANCE.get";
  protected final String TEXT_354 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_355 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_356 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
 ...
 */
    ...
    if (relativeGenmodelPath != null) {
        genModelPathUri = URI.createFileURI(relativeGenmodelPath.substring(1));
    } else {
        ...
        genModelPathUri = URI.createFileURI(tempPath.substring(1));
    }
