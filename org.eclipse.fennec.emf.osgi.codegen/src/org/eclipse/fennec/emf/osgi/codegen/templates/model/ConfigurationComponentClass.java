...
public class ConfigurationComponentClass
{
  ...
  protected final String TEXT_28 = ".eINSTANCE;" + NL + "\t\t" + NL + "\t\tif(!EPackage.Registry.INSTANCE.containsKey(";
  protected final String TEXT_29 = ".eNS_URI)){" + NL + "\t\t\tEPackage.Registry.INSTANCE.put(";
  protected final String TEXT_30 = ".eNS_URI, ePackage);" + NL + "\t\t}" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_31 = "EPackageConfigurator packageConfigurator = registerEPackageConfiguratorService(ePackage, ctx);";
  protected final String TEXT_32 = NL + "\t\tregisterResourceFactoryService(ctx);";
  protected final String TEXT_33 = NL + "\t\tregisterEPackageService(ePackage, packageConfigurator, ctx);" + NL + "\t\tregisterEFactoryService(ePackage, packageConfigurator, ctx);" + NL + "\t\tregisterConditionService(packageConfigurator, ctx);" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * We have to make sure that org.eclipse.emf.ecore is started, so we don't run " + NL + "\t * into start order issues due to the use of static access in EMF " + NL + "\t * @param ctx the {@link BundleContext} to use" + NL + "\t */" + NL + "\tprivate void checkEMFEcore(BundleContext ctx) {" + NL + "\t\t";
  protected final String TEXT_34 = "[] bundles = ctx.getBundles();" + NL + "\t\t" + NL + "\t\tfor(Bundle bundle : bundles) {" + NL + "\t\t\tif(\"org.eclipse.emf.ecore\".equals(bundle.getSymbolicName())) {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tbundle.start();" + NL + "\t\t\t\t} catch (";
  protected final String TEXT_35 = " e) {" + NL + "\t\t\t\t\tSystem.getLogger(getClass().getName()).log(System.Logger.Level.ERROR, \"Could not start Bundle org.eclipse.emf.ecore, something seems seriously wrong\", e);" + NL + "\t\t\t\t}" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * Registers the ";
