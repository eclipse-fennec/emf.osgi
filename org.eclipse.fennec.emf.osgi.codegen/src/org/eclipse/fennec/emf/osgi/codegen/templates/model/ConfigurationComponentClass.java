...
public class ConfigurationComponentClass
{
  ...
  protected final String TEXT_35 = " e) {" + NL + "\t\t\t\t\tSystem.err.println(\"Could not start Bundle org.eclipse.emf.ecore, something seems seriously wrong: \" + e.getMessage());" + NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}" + NL + "\t\t\t\tbreak;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * Registers the ";
